...
const LoginPage: React.FC = () => {
  ...
  //   // This will redirect to http://localhost:3000/auth/google
  //   login();
  // };
  const handleGoogleLogin = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Sign In | TrendWise</title>
        <meta name="description" content="Sign in to TrendWise to comment on articles and access exclusive features." />
      </Helmet>
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Join the conversation and stay updated with the latest trends
          </p>
        </div>
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10">
            ...
            <div className="mt-8 border-t border-gray-200 pt-6">
              <div className="text-center">
                <h3 className="text-sm font-medium text-gray-900 mb-3">Why sign in?</h3>
                <ul className="text-sm text-gray-600 space-y-2">
                  ...
                  <li className="flex items-center justify-center space-x-2">
                    <span className="w-1.5 h-1.5 bg-blue-600 rounded-full"></span>
                    <span>Like and save articles</span>
                  </li>
                  <li className="flex items-center justify-center space-x-2">
                    <span className="w-1.5 h-1.5 bg-blue-600 rounded-full"></span>
